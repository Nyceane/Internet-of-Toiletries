...
public class GaugeView extends View {
	...
	public static final float SCALE_POSITION = 0.0025f;
	...
	public static final int[] OUTER_SHADOW_COLORS = { Color.argb(40, 0, 0, 0), Color.argb(20, 0, 0, 0),
			Color.argb(5, 0, 0, 0) };
	public static final float[] OUTER_SHADOW_POS = { 0.0f, 0.0f, 0.0f };

    public static final float[] RANGE_VALUES = {5.0f, 10.0f, 25.0f, 100.0f};
    public static final int[] RANGE_COLORS = {
			Color.rgb(27, 202, 33), Color.rgb(232, 231, 33),
